...
// Check if the user is already logged in, if yes then redirect to student dashboard page
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT stu_id,stu_name,stu_rollno,stu_password,course_id,batch FROM students WHERE stu_rollno = ?";
